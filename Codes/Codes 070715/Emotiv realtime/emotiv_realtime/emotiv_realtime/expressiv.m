% this file expressiv.m shows how to call expressiv functions in matlab. 
 ...
 while (AllOK == 0 ) 
    ...
    if strcmp(eventType,'EE_EmoStateUpdated') == true        
        ...
        if emoState == 0            
            ...
            smile = calllib('edk','ES_ExpressivGetSmileExtent',eState)
            clench = calllib('edk','ES_ExpressivGetClenchExtent',eState)
            isBlink = calllib('edk','ES_ExpressivIsBlink',eState)
        end    	
    end   
